...
Los productos a vender tienen un nombre, un precio base, y una cantidad en stock, Los tenemos de dos tipos perecederos e imperecederos. Los que caducan tendrán una fecha de reposición (LocalDateTime), según pasa tiempo desde esa fecha el precio del producto se va reduciendo, cada 10 segundos que pasa el precio se reduce un 10%, y si pasa 1 minuto el producto ya no se podrá vender. Cada vez que un reponedor agrega productos se resetea la fecha del producto.
